...
var $author$project$Index$Main$init = function (flag) {
...
var $author$project$Index$Main$subscriptions = function (_v0) {
	return $elm$core$Platform$Sub$none;
};
var $elm$json$Json$Encode$bool = _Json_wrap;
var $author$project$Index$Main$toggleDarkMode = _Platform_outgoingPort('toggleDarkMode', $elm$json$Json$Encode$bool);
var $author$project$Index$Main$update = F2(
	function (msg, model) {
		var darkModeEnabled = model.o ? false : true;
		return _Utils_Tuple2(
			_Utils_update(
				model,
				{o: darkModeEnabled}),
			$author$project$Index$Main$toggleDarkMode(darkModeEnabled));
	});
var $author$project$Index$Main$ToggleDarkMode = 0;
...
var $author$project$Index$Main$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
				$elm$html$Html$Attributes$id('darkModeToggle')
			]),
		_List_fromArray(
			[
				A3(
				...
				_List_fromArray(
					[
						$elm$html$Html$text($author$project$Index$Main$moduleCSS)
					])),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$id('circle'),
								$elm$html$Html$Attributes$classList(
								_List_fromArray(
									[
										_Utils_Tuple2('left', model.o),
										_Utils_Tuple2('right', !model.o)
									]))
							]),
						_List_fromArray(
							[
...
var $author$project$Index$Main$main = $elm$browser$Browser$element(
	{au: $author$project$Index$Main$init, aA: $author$project$Index$Main$subscriptions, aC: $author$project$Index$Main$update, aD: $author$project$Index$Main$view});
_Platform_export({'Index':{'Main':{'init':$author$project$Index$Main$main(
	A2(
		...
		A2($elm$json$Json$Decode$field, 'darkModeEnabled', $elm$json$Json$Decode$bool)))(0)}}});}(this));